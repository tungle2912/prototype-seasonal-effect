...
import { fixedRangeSummary } from '../../state/summaries';
...
const TRIGGER_CHOICES: { label: string; value: TriggerType; helpText: string }[] = [
  {
    ...
    value: 'PAGE_LOAD',
    helpText: 'Starts once the page is interactive. The default, and the right answer most of the time.',
  },
  {
    ...
    <BlockStack gap="400">
      ...
      <Card>
        <BlockStack gap="300">
          ...
          <Text as="p" variant="bodySm" tone="subdued">
            A trigger never makes the campaign appear outside its window, and it does not override an
            effect's own rules — a cursor trail still only runs on desktop.
          </Text>
        </BlockStack>
      </Card>
